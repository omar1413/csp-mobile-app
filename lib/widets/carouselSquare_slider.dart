                  ...
                  child: Stack(
                    ...
                    children:[
                      Container(
                        ...
                        child: Text("السرعة الأن",style: TextStyle(fontWeight: FontWeight.bold ,color: Colors.white),),
                      ),
                      Positioned(
                        top: 74,
                        right: 40,
                        child:Text("120".toString(),style: TextStyle(fontWeight: FontWeight.bold ,color: Colors.white , fontSize: 24),)),
                      Positioned(
                        top: 50,
                        left: 10,
                        child: Container(
                       ...
                       Positioned(
                        top: 90,
                        right: 80,
                        child:Text("كم/س".toString(),style: TextStyle(fontWeight: FontWeight.bold ,color: Colors.white , fontSize:11),)),
                  ...
                  child: Stack(
                    children:[
                      Container(
                        ...
                        child: Text("مشمس",style: TextStyle(fontWeight: FontWeight.bold ,color: Colors.white),),
                      ),
                      Positioned(
                        top: 70,
                        right: 40,
                        child:Text("28 ْ".toString(),style: TextStyle(fontWeight: FontWeight.bold ,color: Colors.white , fontSize: 26),)),
                      Positioned(
                        top: 90,
                        right: 70,
                        child:Text("س".toString(),style: TextStyle(fontWeight: FontWeight.bold ,color: Colors.white , fontSize:11),)),
                  ...
                  child: Stack(
                    children:[
                      Container(
                        ...
                        child: Text("حادث على طريق صلاح سالم",style: TextStyle(fontWeight: FontWeight.bold ,color: Colors.white),),
